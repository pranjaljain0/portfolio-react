                ...
                EducationObj.map((Obj,index)=>{
                    return(
                        ...
                        >
                            ...
                            <h5 className="vertical-timeline-element-subtitle">{Obj.location_city}</h5>
                            <h6 className="vertical-timeline-element-subtitle">{Obj.location_state}</h6>
                            <h6 className="vertical-timeline-element-subtitle">{Obj.location_country}</h6>
                            <p>
                            {Obj.description}
                            </p>
                            <p>
