        ...
        return (
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                ...
                <Nav className="navbar-right">
                    ...
                    <Nav.Link href="#link"><FaGithub color="rgba(255,255,255,0.8)" size="1.5em"/></Nav.Link>
                    <Nav.Link href="#link"><FaLinkedin color="rgba(255,255,255,0.8)" size="1.5em"/></Nav.Link>
                </Nav>
